...
async function loadData() {
  const cached = localStorage.getItem("cache-all");
  if (cached) {
...
;
  ...
  allFiles = tempFiles;
  localStorage.setItem("cache-all", JSON.stringify(allFiles));
  renderSidebar();
...
function showList(subtype) {
  ...
  list.innerHTML = '';
  document.getElementById("subcategoryTitle").textContent = subtype;
